            ...
            <table class="table">
                ...
                <c:forEach varStatus="i" var="item" items="${data.content}">
                    <tr>
                        ...
                        <td>
                            <a href="/san-pham/delete/${item.id}">
                                <button class="btn btn-danger">Xóa</button>
                            </a>
                            <a href="/san-pham/edit/${item.id}">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <c:if test="${totalPages > 0}">
                            <c:if test="${currentPage > 0}">
                                <li class="page-item">
                                    <a class="page-link" href="/san-pham/tim-kiem?valueSearch=${valueSearch}&page=${currentPage - 1}">&lt;&lt;</a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach var="i" begin="0" end="${totalPages - 1}">
                                <li class="page-item <c:if test="${currentPage == i}">active</c:if>">
                                    <a class="page-link" href="/san-pham/tim-kiem?valueSearch=${valueSearch}&page=${i}">${i + 1}</a>
                                </li>
                            </c:forEach>
